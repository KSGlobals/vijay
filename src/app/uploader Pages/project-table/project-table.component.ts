...
@Component({
  selector: 'app-uploader-task-page',
...
export class ProjectTableComponent implements OnInit {
  ...
  profile() {
    this.router.navigate(['uploader-profile']);
  }
  async fetch() {
    this.firestore
      .collection('Project')
  ...
  async deleteTask(task: any) {
    ...
    var Messagebody = {
      ...
      message: 'The Documents have been Uploaded and waiting for approval',
      mail_to: 'amarnath.vasu@skyx.co.in',
      cc_to: 'adarsh@skyx.co.in,amarnath.vasu@skyx.co.in',
      reply_to: `${this.currentUserEmail},adarsh@skyx.co.in`,
    };
  ...
  viewTask(title: string) {
    this.router.navigate(['uploader-viewing'], {
      queryParams: {
        title,
      },
    });
            ...
            return this.firestore
              ...
              .then(() => {
                ...
                this.notificationService.showNotification(
                  'info',
                  `File Uploaded Successfully Waiting for Approval by!${userName}`
                );
                var Messagebody = {
                  from: this.currentUserEmail,
                  from_name: userName,
                  ...
                  message:
                    'The Documents have been Uploaded and waiting for approval',
                  mail_to: 'amarnath.vasu@skyx.co.in',
                  cc_to: 'adarsh@skyx.co.in,amarnath.vasu@skyx.co.in',
                  reply_to: `${this.currentUserEmail},adarsh@skyx.co.in`,
                };
                emailjs.init('PG28t0CWuuPLA-Kw1');
                emailjs
                  .send('service_d13p9lv', 'template_27kljbp', Messagebody)
                  .then(
                    (response) => {
                      console.log('SUCCESS!', response.status, response.text);
                      this.toastr.success('Email Sent!!!, Success!!!');
