...
@Component({
  selector: 'app-admin-projectmanagercreation',
  templateUrl: './projectmanagercreation.component.html',
  styleUrls: ['./projectmanagercreation.component.scss'],
})
export class ProjectmanagercreationComponent implements OnInit {
  insuranceForm: any;
  ...
  async submit() {
    ...
    if ((this.currentUserEmail = 'amarnath.vasu@skyx.co.in')) {
      this.afAuth
        ...
        .then(() => {
          this.afAuth.signInWithEmailAndPassword(
            'amarnath.vasu@skyx.co.in',
            pass
          );
        });
    }
    this.ngxLoader.stop();
    this.router.navigate(['admin-manager-view']);
  }
  fetchDocumentId() {
      ...
      try {
        ...
        if (!querySnapshot.empty) {
          ...
          querySnapshot.forEach((doc) => {
            ...
            console.log('Current User Type:', pass);
          });
