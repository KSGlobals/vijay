...
export class ViewComponent implements OnInit {
  ...
  delete1() {
    ...
    this.route.queryParams.subscribe(async (params) => {
      ...
      const Name = await this.getUploadername(name);
      const uploadedBy = Name[0].userName;
      console.log(taskTitle);
      console.log(this.currentUserEmail, userName, name, uploadedBy);
      var Messagebody = {
        from: this.currentUserEmail,
        from_name: userName,
        to_name: name,
        subject: 'Deleted OrthoFiles',
        message: `Ortho Files Deleted Reupload it because ${this.viewForm.value.comments}`,
        mail_to: uploadedBy,
  ...
  delete2() {
    ...
    this.route.queryParams.subscribe(async (params) => {
      ...
      var Messagebody = {
        ...
        from_name: userName,
        to_name: name,
        subject: 'Deleted Demfiles',
        message: `Dem files Deleted Reupload it because ${this.viewForm.value.comments}`,
        mail_to: uploadedBy,
        reply_to: this.currentUserEmail,
        cc_to: 'adarsh@skyx.co.in,amarnath.vasu@skyx.co.in',
      };
  ...
  delete3() {
    ...
    this.route.queryParams.subscribe(async (params) => {
      const taskTitle = params['title'];
      const name = params['name'];
      await this.getUploadername(name);
      await this.getCurrentUserEmail();
      const user = await this.getUsername(this.currentUserEmail);
      const userName = user[0].userType;
      const Name = await this.getUploadername(name);
      ...
      var Messagebody = {
        ...
        from_name: userName,
        to_name: name,
        subject: 'Deleted Survey Files',
        message: `Survey Files deleted Reupload it because ${this.viewForm.value.comments}`,
        mail_to: uploadedBy,
        reply_to: this.currentUserEmail,
        cc_to: 'adarsh@skyx.co.in,amarnath.vasu@skyx.co.in',
      };
      ...
      emailjs.send('service_d13p9lv', 'template_27kljbp', Messagebody).then(
        (response) => {
          this.firestore
            .collection('Project')
            .doc(taskTitle)
            .update({ Downloadurl6: null, status: 'Rework' });
          console.log('SUCCESS!', response.status, response.text);
          this.toastr.success('Email Sent!!!, Success!!!');
          this.ngxloader.stop();
          setTimeout(() => {
  ...
  delete4() {
    ...
    this.route.queryParams.subscribe(async (params) => {
      ...
      var Messagebody = {
        ...
        from_name: userName,
        to_name: name,
        subject: 'Deleted 3d files',
        message: `3d files deleted Reupload it because ${this.viewForm.value.comments}`,
        mail_to: uploadedBy,
        reply_to: this.currentUserEmail,
        cc_to: 'adarsh@skyx.co.in,amarnath.vasu@skyx.co.in',
      };
      ...
      emailjs.send('service_d13p9lv', 'template_27kljbp', Messagebody).then(
        (response) => {
          this.firestore
            .collection('Project')
            .doc(taskTitle)
            .update({ Downloadurl7: null, status: 'Rework' });
          console.log('SUCCESS!', response.status, response.text);
          this.toastr.success('Email Sent!!!, Success!!!');
          this.ngxloader.stop();
          setTimeout(() => {
      ...
      const path = `Project/${taskTitle}/3D View`;
  ...
  delete5() {
    ...
    this.route.queryParams.subscribe(async (params) => {
      ...
      var Messagebody = {
        ...
        from_name: userName,
        to_name: name,
        subject: 'Deleted KMZ files',
        message: `Deleted KMZ files Reupload it because ${this.viewForm.value.comments}`,
        mail_to: uploadedBy,
        reply_to: this.currentUserEmail,
        cc_to: 'adarsh@skyx.co.in,amarnath.vasu@skyx.co.in',
      };
      ...
      try {
        ...
        if (!querySnapshot.empty) {
          ...
          querySnapshot.forEach((doc) => {
            ...
            const userName = currentUserDoc.email;
            const userType = currentUserDoc.name;
