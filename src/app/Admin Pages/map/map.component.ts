...
export class MapComponent implements OnInit {
  ...
  back() {
    this.route.queryParams.subscribe((params) => {
      ...
      this.router.navigate(['admin-view'], { queryParams: { title } });
    });
  }
  toggleSidebar() {
