...
export class ProfileComponent implements OnInit {
  ...
  async submit() {
    ...
    if (this.currentUserEmail === 'admin2@gmail.com') {
      this.afAuth
        ...
        .then(() => {
          this.afAuth.signInWithEmailAndPassword('admin2@gmail.com', pass);
        })
        .then(() => {
          this.uploadfile();
    ...
    } else if (this.currentUserEmail === 'amarnath.vasu@skyx.co.in') {
      this.afAuth
        .createUserWithEmailAndPassword(
          this.insuranceForm.value.email,
          this.insuranceForm.value.password
