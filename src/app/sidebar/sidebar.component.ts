...
export class SidebarComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    if (sessionActiveIndex !== null) {
      ...
      let localActiveIndex = localStorage.getItem('activeIndex') as any;
      this.activeIndex = Number(localActiveIndex);
      console.log(typeof localActiveIndex);
      console.log(localActiveIndex);
